...
The Streamlit frontend deployed successfully,
but the FastAPI backend and Ollama model
are still running locally on your machine.

To make AI features work online,
the backend must also be deployed.
""")
